...
const Footer = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-12 md:h-24 lg:h-32 -mb-1 block" preserveAspectRatio="none">
      ...
      <footer className="text-base pt-10 pb-6 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Brand Info */}
          <div>
            <h2 className="text-2xl font-bold text-primary mb-4">Konilicious</h2>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#home" className="text-gray-300 hover:font-bold transition-all">Home</a>
              </li>
              <li>
                <a href="#menu" className="text-gray-300 hover:font-bold transition-all">Our Menu</a>
              </li>
              <li>
                <a href="#about" className="text-gray-300 hover:font-bold transition-all">About Us</a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:font-bold transition-all">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-300">
              <li className="flex items-center gap-3"><FaMapMarkerAlt/> Jl. Kertanegara VI, Pleburan, Kec. Semarang Sel., Kota Semarang, Jawa Tengah 50241</li>
              <li className="flex items-center gap-3"><FaPhoneAlt/> +62 812 3456 7890</li>
              <li className="flex items-center gap-3"><FaEnvelope/> hello@konilicious.com</li>
            </ul>
          </div>
        </div>
